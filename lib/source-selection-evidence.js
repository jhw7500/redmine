...
const { buildSourceRecords, renderSourceSelection } = require('./source-selection');

function enforceSourceSelectionStatus(validation, method) {
...
function assertSourceSelectionEvidence({run, snapshot, generationState, annotatedContent, promptInput, validation}) {
