...
function hasMarkerLikePrefixAt(source, cursor, markerName) {
  ...
  for (const letter of markerName) {
...
function parseAnnotatedDraft(content) {
  ...
  while (cursor < source.length) {
    ...
    const factLikeMarker = !exactMarker && hasMarkerLikePrefixAt(source, cursor, "fact");
...
module.exports = { hasMarkerLikePrefixAt, parseAnnotatedDraft, renderCleanDraft };
